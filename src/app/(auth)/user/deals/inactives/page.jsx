    ...
    useEffect(() => {
        ...
        const getData = async () => {
            try {
                ...
                const response = await api.get('/deal/getAll/0');
            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div className="bg-white shadow ">
                    <div className="px-4 py-5 sm:p-6">
                        <h3 className="text-base font-semibold leading-6 text-green-700">Propostas Desativadas</h3>
                        <div className="mt-2 sm:flex sm:items-start sm:justify-between">
                            <div className="max-w-xl text-sm text-gray-500">
                                <p>
                                    Relação de negócios fechados e propostas aprovadas
                                </p>
                            </div>
