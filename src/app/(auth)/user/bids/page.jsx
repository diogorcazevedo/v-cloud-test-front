            ...
            <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="px-4 py-5 sm:p-6">
                        ...
                        <div className="mt-2 sm:flex sm:items-start sm:justify-between">
                            <div className="max-w-xl text-sm text-gray-500">
                                <p>
                                    Todas as propostas enviadas com minhas ofertas para produtos do meu interesse
                                </p>
                            </div>
                ...
                <table className="border mt-8 min-w-full divide-y divide-x divide-gray-200">
                    ...
                    <tr className="divide-x divide-y divide-gray-200">
                        ...
                        <th  className="text-sm text-gray-900 p-2 py-2">Valor Proposto</th>
                        <th  className="text-sm text-gray-900 p-2 py-2">Status</th>
                        <th  colSpan= "3" className="text-sm  text-gray-900 p-2 py-6">
                            Ação
                        </th>
                    </tr>
                    </thead>
